...
template<> struct Traits<Build>
{
    ...
    enum {IA32, ARMv7, ARM7};
    static const unsigned int ARCHITECTURE = ARM7;

    enum {PC, Cortex_M, Cortex_A, MC13224V};
    static const unsigned int MACHINE = MC13224V;

    enum {Legacy_PC, eMote3, LM3S811, eMote2};
